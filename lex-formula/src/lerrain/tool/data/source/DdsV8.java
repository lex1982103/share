...
public class DdsV8 implements DataSource
{
...
//			System.out.println("readed " + groupName + " in " + (System.currentTimeMillis() - s) + "ms");
	...
	public String[] getGroupsName()
	{
		...
		try
		{
			...
			if (version != 8)
				throw new Exception("version incorrect! this version is " + version + "; this parser is DDS-V8");
