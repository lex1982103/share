    ...
    16: function (e, t, n) {
        ...
        var r = function (e) {
            function t(e) {
                ...
                return n.state = {images: e.images || [], initialized: !1}, n
            }
            ...
            return function (e, t) {
                ...
                key: "componentWillReceiveProps", value: function (e) {
                    void 0 !== e.images && null !== e.images && this.setState({images: e.images || ""}, function () {
                        this.initSwiper()
                    })
                }
            }, {
                key: "render", value: function () {
                    return React.createElement("div", {className: "swiper-container"}, React.createElement("div", {className: "swiper-wrapper"}, this.state.images.map(function (e, t) {
                        return React.createElement("div", {
                            className: "swiper-slide",
                            key: "banner" + t
                        }, React.createElement("a", {href: e.link || ""}, React.createElement("img", {src: e.url})))
        ...
        }(), c = n(16), i = (a = c) && a.__esModule ? a : {default: a};
        var l = "http://114.112.96.61:7666/", o = function (e) {
            function t() {
                !function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t);
                ...
                return e.state = {images: [], searchInputting: !1, searchText: "", products: []}, e
            }
            ...
            return function (e, t) {
                ...
                key: "componentDidMount", value: function () {
                    window.MF && MF.setTitle("首页"), this.fetchBanner(), this.fetchProduct()
                }
            }, {
                key: "fetchProduct", value: function () {
                    var e = this;
                    $.ajax({
                        url: l + "client/queryPage",
                        type: "GET",
                        xhrFields: {withCredentials: !1},
                        success: function (t) {
                            e.setState({products: t.rows || []})
                        },
                        fail: function (e) {
                        },
                        dataType: "json"
                ...
                key: "fetchBanner", value: function () {
                    ...
                    $.ajax({
                        ...
                        success: function (t) {
                            if (t.result == "success") {
                                var n = t.content.list.map(function (e) {
                                    return {url: l + e.url, link: l + e.link}
                                });
                                e.setState({images: n});
                            }
                ...
                key: "openApply", value: function (e) {
                    window.MF && MF.navi("insurance/insurance.html")
                   /* APP.openApply('/order/list.json', r => {
                        window.MF && MF.navi("insurance/insurance.html")
                    })*/
                }
            }, {
                key: "newApply", value: function () {
                    window.MF && MF.navi("apply/start.html")
                }
            }, {
                key: "openProposal", value: function () {
                    window.MF && MF.navi("proposal/start.html")
                }
            }, {
                key: "openCustomer", value: function () {
                    window.MF && MF.navi("client/client_list.html")
                }
            }, {
                key: "render", value: function () {
                    var e = this;
                    return React.createElement("div", {className: "home-container"}, React.createElement("div", {className: "banner-wrap"}, React.createElement(i.default, {images: this.state.images}), React.createElement("div", {className: "banner-header"}, React.createElement("div", {className: "banner-logo"}, React.createElement("img", {src: "../images/home/logo.png"})), React.createElement("div", {className: "banner-search"}, !this.state.searchInputting && !this.state.searchText && React.createElement("div", null, React.createElement("span", null, React.createElement("img", {src: "../images/home/search.png"})), React.createElement("span", null, "搜索产品 / 客户信息")), React.createElement("input", {
                        onFocus: function () {
                            return e.setState({searchInputting: !0})
                        }, onBlur: function () {
                            return e.setState({searchInputting: !1})
                        }, onChange: function (t) {
                            return e.setState({searchText: t.target.value})
                        }
                    })), React.createElement("div", {className: "banner-msg"}, React.createElement("img", {src: "../images/home/message.png"}), React.createElement("em", null)))), React.createElement("div", {className: "shortcut-row1"}, React.createElement("a", {
                        className: "srow-item",
                        href: "javascript:void(0)",
                        onClick: this.newApply.bind(this)
                    }, React.createElement("div", null, React.createElement("img", {src: "../images/home/oneKey.png"})), React.createElement("span", null, "一键投保")), React.createElement("a", {
                        className: "srow-item",
                        href: "javascript:void(0)",
                        onClick: this.openProposal.bind(this)
                    }, React.createElement("div", null, React.createElement("img", {src: "../images/home/proposal.png"})), React.createElement("span", null, "建议书")), React.createElement("a", {
                        className: "srow-item",
                        href: "javascript:void(0)",
                        onClick: this.openApply.bind(this)
                    }, React.createElement("div", null, React.createElement("img", {src: "../images/home/insurePolicy.png"})), React.createElement("span", null, "投保单")), React.createElement("a", {className: "srow-item"}, React.createElement("div", null, React.createElement("img", {src: "../images/home/insure.png"})), React.createElement("span", null, "投保e办理")), React.createElement("a", {className: "srow-item"}, React.createElement("div", null, React.createElement("img", {
                        src: "../images/home/customer.png",
                        onClick: this.openCustomer.bind(this)
                    })), React.createElement("span", null, "客户管理"))), React.createElement("div", {className: "shortcut-row2"}, React.createElement("a", {className: "sr2-left"}, React.createElement("img", {src: "../images/home/company.png"}), React.createElement("span", null, "公司介绍")), React.createElement("div", {className: "sr2-right"}, React.createElement("a", {class: "sr2-top"}, React.createElement("img", {src: "../images/home/product.png"}), React.createElement("span", null, "产品介绍")), React.createElement("div", {class: "sr2-bottom"}, React.createElement("a", null, React.createElement("span", null, "自主经营"), React.createElement("img", {src: "../images/home/independent.png"})), React.createElement("a", null, React.createElement("span", null, "展示夹"), React.createElement("img", {src: "../images/home/showHome.png"}))))), React.createElement("div", {className: "promote"}, React.createElement("div", {className: "p-title"}, React.createElement("span", null, "热销推荐"), React.createElement("a", null, "查看更多 >")), React.createElement("div", {className: "p-content"}, this.state.products.map(function (e) {
                        return React.createElement("a", {className: "prod-item"}, React.createElement("img", {src: e.logo ? l + e.logo : "../images/home/default_img.png"}), React.createElement("span", null, e.abbrName), React.createElement("i", null, e.name))
                    }))))
                }
            }]), t
        }();
